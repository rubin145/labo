...
PARAM  <- list()
PARAM$exp_input  <- "3_FE_HISTORIA"
PARAM$experimento <- "4d_TRAINING_STRATEGY"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c( 202012,202101, 202102, 202103, 202104, 202105 )

PARAM$train$training     <- c( 202012,202101, 202102, 202103, 202104, 202105 )
PARAM$train$validation   <- c( 202012, 202101, 202102, 202103, 202104, 202105 )
PARAM$train$testing      <- c( 202012, 202101, 202102, 202103, 202104, 202105 )
...
PARAM$train$undersampling_mayoritaria  <- 0.02  # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
