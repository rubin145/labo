...
PARAM$experimento <- "4a_TRAINING_STRATEGY"
...
PARAM$train$sampling_total  <- .75  # 1.0 significa que NO se hace sampling total,  0.3 es quedarse con el 30% de TODOS los registros
