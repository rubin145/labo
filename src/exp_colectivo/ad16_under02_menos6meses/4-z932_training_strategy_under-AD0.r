...
PARAM  <- list()
PARAM$experimento <- "EC16-4-train_strategy"

PARAM$exp_input  <- "EC00-3-FE_historia"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c( 201911,201912, 202011, 202012, 202101, 202102, 202103)

PARAM$train$training     <- c( 201911,201912, 202011, 202012, 202101, 202102, 202103)
