...
PARAM  <- list()
PARAM$experimento <- "EC15-4-train_strategy"

PARAM$exp_input  <- "EC00-3-FE_historia"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c( 202003,202004,202005,202006,202007,202008,202009,202010, 202011, 202012, 202101, 202102, 202103)

PARAM$train$training     <- c( 202003,202004,202005,202006,202007,202008,202009,202010, 202011, 202012, 202101, 202102, 202103)
