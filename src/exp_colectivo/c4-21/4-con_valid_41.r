...
PARAM  <- list()
PARAM$experimento <- "EC41-4-train_strategy"

PARAM$exp_input  <- "EC21-3-FE_historia"

PARAM$future       <- c(201901,201902,201903,201904,202001,202002,202003,202004, 202005,202006,202007,202008,202009,202010,202107,202109)

PARAM$final_train  <- c( 201905,201906,201907,201908,201909,201910,201911,201912, 202011, 202012, 202101, 202102, 202103,202106)
...
fwrite( dataset[ foto_mes %in% PARAM$train$validation, ],
        file= "dataset_validation_final.csv.gz",
        logical01= TRUE,
        sep= "," )
