...
meses_train <- c(201907,201908,201909,201910,202011,202012,202101,202102,202103,202106)
train_final <- fread(paste0(dir_in,'/','dataset_train_final.csv.gz'))

fwrite( train_final[foto_mes %in% meses_train, ],
        file= paste0(dir_in,'/','dataset_train_final.csv.gz'),
        logical01= TRUE,
        sep= "," )
rm(train_final)
